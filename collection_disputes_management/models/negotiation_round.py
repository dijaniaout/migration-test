...
class NegotiationRound(models.Model):
    _name = 'collection_disputes_management.negotiation_round'
    _description = "Round de négociation"
    _inherit = ['mail.thread', 'mail.activity.mixin']

    agreement_id = fields.Many2one('collection_disputes_management.transaction_agreement', string="Accord transactionnel", required=True, ondelete='cascade')
    ...
    line_ids = fields.One2many(
        'collection_disputes_management.negotiation_round_line',
        'round_id',
    ...
    limit_rule_id = fields.Many2one('collection_disputes_management.negotiation_limit_rule',string="Règle de limite appliquée")
...
class NegotiationRoundLine(models.Model):
    _name = 'collection_disputes_management.negotiation_round_line'
    _description = "Condition du round de négociation"

    round_id = fields.Many2one('collection_disputes_management.negotiation_round', string="Round", ondelete='cascade', required=True)
