...
class NegotiationLimitRule(models.Model):
    _name = 'collection_disputes_management.negotiation_limit_rule'
    ...
    line_ids = fields.One2many(
        'collection_disputes_management.negotiation_limit_rule_line',
        'rule_id',
...
class NegotiationLimitRuleLine(models.Model):
    _name = 'collection_disputes_management.negotiation_limit_rule_line'
    _description = "Ligne de règle de négociation"

    rule_id = fields.Many2one(
        'collection_disputes_management.negotiation_limit_rule',
        string="Règle",
        required=True,
        ondelete='cascade'
    )
