...
class AdditionalFee(models.Model):
    _name = 'collection_disputes_management.additional_fee'
    ...
    auxiliary_id = fields.Many2one('collection_disputes_management.justice_auxiliary', string="Auxiliaire de justice")
