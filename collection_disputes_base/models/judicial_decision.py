...
class JudicialDecision(models.Model):
    _name = 'collection_disputes_base.judicial_decision'
    ...
    dispute_case_id = fields.Many2one('collection.dispute.case', string="Créance concerné", ondelete='cascade')
    ...
    condemnation_ids = fields.One2many(
        'collection_disputes_base.judicial_decision_condemnation',
        'decision_id',
