...
class LegalDispute(models.Model):
    _name = 'collection_disputes_base.legal_dispute'
    ...
    type_litige_id = fields.Many2one('collection_disputes_base.legal_dispute_type', string='Type', required=True)
    ...
    justice_intervention_ids = fields.One2many('collection_disputes_base.justice_intervention', 'legal_dispute_id', string="Interventions de Justice")
    currency_id = fields.Many2one('res.currency', string="Devise", default=lambda self: self.env.company.currency_id)  
    additional_fee_ids = fields.One2many('collection_disputes_base.additional_fee', 'legal_dispute_id', string="Frais annexes")
    ...
    justice_auxiliary_ids = fields.Many2many("collection_disputes_base.justice_auxiliary", "justice_auxiliary_lit", string="Conseiller juridique")
    ...
    def _default_base_workflow_id(self):
        return self.env.ref('collection_disputes_base.workflow_dispute', raise_if_not_found=False)
