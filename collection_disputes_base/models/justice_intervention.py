...
class JusticeIntervention(models.Model):
    _name = 'collection_disputes_base.justice_intervention'
    ...
    legal_dispute_id = fields.Many2one('collection_disputes_base.legal_dispute', string='Dossier de litige')
    intervention_type_id = fields.Many2one('collection_disputes_base.intervention_type', string="Type d'intervention", required=True)
